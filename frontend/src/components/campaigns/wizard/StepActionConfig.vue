<template>
  ...
  <div v-else-if="selectedAction.key === 'invite'" class="space-y-6">
    <div>
      <h2 class="text-xl font-bold text-gray-900 mb-2">Configure Connection Request</h2>
      <p class="text-sm text-gray-600">Choose whether to include a note with your invitation</p>
    </div>
    ...
    <div class="space-y-4">
      ...
      >
        <div class="flex items-center">
          ...
          />
          <div class="ml-3">
            <div class="text-sm font-medium text-gray-900">Send without note</div>
            <div class="text-xs text-gray-500">Send connection request without a message</div>
          </div>
        </div>
      </div>
      ...
      >
        <div class="flex items-center">
          ...
          />
          <div class="ml-3">
            <div class="text-sm font-medium text-gray-900">Send with personalized note</div>
            <div class="text-xs text-gray-500">Include a message (max 300 characters)</div>
          </div>
        </div>
      </div>
      ...
      <div v-if="campaignData.inviteWithNote" class="ml-7 mt-4">
        ...
        <div v-if="invitationTemplates.length === 0" class="text-sm text-gray-500 p-4 bg-gray-50 rounded-lg">
        ...
        <template v-else>
          ...
          <div v-if="campaignData.selectedTemplateId" class="mt-3 p-3 bg-gray-50 rounded-lg">
  ...
  <div v-else-if="selectedAction.key === 'message'" class="space-y-6">
    <div>
      <h2 class="text-xl font-bold text-gray-900 mb-2">Configure Message</h2>
      <p class="text-sm text-gray-600">Select a message template to send</p>
    </div>
    ...
    <div>
      ...
      <div v-if="messageTemplates.length === 0" class="text-sm text-gray-500 p-4 bg-gray-50 rounded-lg">
  ...
  <div v-else-if="selectedAction.key === 'email'" class="space-y-6">
    <div>
      <h2 class="text-xl font-bold text-gray-900 mb-2">Configure Email</h2>
    ...
    <div>
      ...
      <div v-if="emailTemplates.length === 0" class="text-sm text-gray-500 p-4 bg-gray-50 rounded-lg">
      ...
      <template v-else>
        ...
        <div v-if="campaignData.selectedTemplateId" class="mt-3 p-3 bg-gray-50 rounded-lg">
          <div class="text-xs text-gray-500 mb-1">Email Preview:</div>
          <div class="text-sm text-gray-700">
  ...
  <div v-else-if="selectedAction.key === 'connect_message'" class="space-y-6">
    <div>
      <h2 class="text-xl font-bold text-gray-900 mb-2">Configure Connect + Message</h2>
      <p class="text-sm text-gray-600">
    ...
    <div class="p-4 border border-gray-200 rounded-lg">
      <div class="flex items-center mb-3">
        ...
        <div>
          <div class="text-sm font-medium text-gray-900">If Connected</div>
          <div class="text-xs text-gray-500">Message to send to existing connections</div>
        </div>
      </div>
      ...
      <div v-if="messageTemplates.length === 0" class="text-sm text-gray-500 p-3 bg-gray-50 rounded-lg">
      ...
      <template v-else>
        ...
        <div v-if="campaignData.selectedTemplateId" class="mt-2 p-2 bg-gray-50 rounded text-sm text-gray-600">
          {{ messageTemplates.find(t => t.id === campaignData.selectedTemplateId)?.content }}
        </div>
      </template>
    </div>
    ...
    <div class="p-4 border border-gray-200 rounded-lg">
      <div class="flex items-center mb-3">
        ...
        <div>
          <div class="text-sm font-medium text-gray-900">If Not Connected</div>
          <div class="text-xs text-gray-500">Connection request note (max 300 chars)</div>
        </div>
      </div>
      ...
      <div v-if="invitationTemplates.length === 0" class="text-sm text-gray-500 p-3 bg-gray-50 rounded-lg">
      ...
      <template v-else>
        ...
        <div v-if="campaignData.inviteTemplateId" class="mt-2 p-2 bg-gray-50 rounded text-sm text-gray-600">
  ...
  <div v-else-if="selectedAction.key === 'visit_follow_connect'" class="space-y-6">
    <div>
      <h2 class="text-xl font-bold text-gray-900 mb-2">Configure Visit + Follow + Connect</h2>
      <p class="text-sm text-gray-600">
    ...
    <div class="p-4 border border-gray-200 rounded-lg">
      <div class="flex items-center mb-3">
        ...
        <div>
          <div class="text-sm font-medium text-gray-900">Connection Request Note</div>
          <div class="text-xs text-gray-500">Message sent with connection request (max 300 chars)</div>
        </div>
      </div>
  ...
  <div v-else-if="selectedAction.key === 'email_message'" class="space-y-6">
    <div>
      <h2 class="text-xl font-bold text-gray-900 mb-2">Configure Email + Message</h2>
      <p class="text-sm text-gray-600">
    ...
    <div class="p-4 border border-gray-200 rounded-lg">
      <div class="flex items-center mb-3">
        ...
        <div>
          <div class="text-sm font-medium text-gray-900">Primary: Email</div>
          <div class="text-xs text-gray-500">Sent when prospect has an email address</div>
        </div>
      </div>
      ...
      <div v-if="emailTemplates.length === 0" class="text-sm text-gray-500 p-3 bg-gray-50 rounded-lg">
      ...
      <template v-else>
        ...
        <div v-if="campaignData.selectedTemplateId" class="mt-2 p-2 bg-gray-50 rounded">
    ...
    <div class="p-4 border border-gray-200 rounded-lg">
      <div class="flex items-center mb-3">
        ...
        <div>
          <div class="text-sm font-medium text-gray-900">Fallback: LinkedIn Message</div>
          <div class="text-xs text-gray-500">Sent when no email can be found</div>
        </div>
      </div>
      ...
      <template v-else>
        ...
        <div v-if="campaignData.fallbackTemplateId" class="mt-2 p-2 bg-gray-50 rounded text-sm text-gray-600">
