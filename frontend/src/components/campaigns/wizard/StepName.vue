<template>
  <div class="space-y-6">
    <div>
      <h2 class="text-xl font-bold text-theme-primary mb-2">Campaign Details</h2>
      <p class="text-sm text-theme-secondary">Give your campaign a name and description</p>
    </div>
